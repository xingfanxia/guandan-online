...
**Date**: 2026-06-09 (playability audit — `c311449`: flat-vs-nested move-body wire mismatch + never-emitted snapshot event + handle-normalization drift + stale cross-round currentTurn + unmounted RoundEnd/Victory screens, all fixed; **first build verified fully playable by driving the real UI through multiple rounds locally AND on the production henna alias**; 1544 tests; full detail in CLAUDE.md § Last updated 2026-06-09). Earlier: SSE black-screen fix 2026-05-29 (`9967a5b`); v1 ship 2026-05-28; audit-fix loop 2026-05-22; route-signature fix + UI-7 rotate 2026-05-21.
